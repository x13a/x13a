...
| --- | --- |
| [Silence](https://github.com/x13a/Silence) | Block unknown callers |
...
| [syscall-swift](https://github.com/x13a/syscall-swift) | Swift wrappers for selected system calls |
| [homebrew-tap](https://github.com/x13a/homebrew-tap) | Homebrew tap for my projects |

#### Linux

| Repository | Description |
| --- | --- |
| [setup-server](https://github.com/x13a/setup-server) | Bootstrap scripts for Ubuntu Server |
| [caddy-l4-docker](https://github.com/x13a/caddy-l4-docker) | Hardened Docker image of Caddy with the L4 plugin |

#### Libraries

| Repository | Description |
| --- | --- |
| [py-minisign](https://github.com/x13a/py-minisign) | Python library for Minisign signatures |
